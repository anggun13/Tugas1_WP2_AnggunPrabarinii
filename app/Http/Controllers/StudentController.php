...
class StudentController extends Controller
{
    ...
    {
        //ini jon sudah ada. Jadi tinggal diedit bae.
...
return redirect('/students')->with('success', 'Students deleted successfully.');
    ...
    //perhatikan errore ya, tulisane "Cannot Redeclare" berarti wes ada function yang sama jadi gak usah bikin lagi. Bisane ngerti pak? coba kita cek ya.
